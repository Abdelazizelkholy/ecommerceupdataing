  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="app_nav">
      <ul class="nav navbar-nav">
          <li ><a href="Categories.php"><?php echo lang('CATOGERIES');   ?> </a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">abdelaziz <span class="caret"></span></a>
